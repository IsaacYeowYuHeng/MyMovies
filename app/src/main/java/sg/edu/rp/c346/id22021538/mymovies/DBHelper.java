...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public ArrayList<String> getRatings() {
        ...
        Cursor cursor = db.query(TABLE_MOVIE, new String[]{COLUMN_RATING}, null, null,
                COLUMN_RATING, null, null, null);
        if (cursor.moveToFirst()) {
            do {
                ratings.add(cursor.getString(0));
    ...
    public ArrayList<Movie> getMoviesByRating(String filter) {
    ...
    public void insertTask(String title, String genre, int finalYear, String rating) {
    }
}
